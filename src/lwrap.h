...
void lbaccentsheader(self ** me);
void lbarabicheader(self ** me);
void lbarmeniheader(self ** me);
void lbcyrilheader(self ** me);
void lbgreekheader(self ** me);
void lbhebrewheader(self ** me);
void lbipaheader(self ** me);
void lbnkoheader(self ** me);
void lbsyriacheader(self ** me);
void lbthaanaheader(self ** me);
